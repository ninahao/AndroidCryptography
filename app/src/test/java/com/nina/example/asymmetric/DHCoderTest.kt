...
class DHCoderTest {
    ...
    fun initKey() {
        ...
        val keyMap2 = DHCoder.initKey(publicKey1)
    ...
    fun test() {
        ...
        val code1 = DHCoder.encrypt(inputStr1.toByteArray(Charsets.UTF_8), key1)
        println("cipher text: ${encodeBase64(code1)}")

        println("decrypt data by part B local secret key")
        val decode1 = DHCoder.decrypt(code1, key2)
        ...
        val code2 = DHCoder.encrypt(inputStr2.toByteArray(Charsets.UTF_8), key2)
        println("cipher text: ${encodeBase64(code2)}")

        println("decrypt data by part A local secret key")
        val decode2 = DHCoder.decrypt(code2, key1)
